...
from fn_hologram_concert_mission import *
from fn_test import *
from simple_test import simple_move
from fn_line_follow_stop_4 import *
...
menu_options = ("1", "2", "M", "D", "X") #forward, left, right, back, exit
menu_index = 0
...
while True:
    ...
    if selected == "1":
        print("line_follow_3")
        line_follow_4(hub, motor_left, motor_right, motor_attach_right, 
