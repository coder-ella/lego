...
def camera_run(hub, bob, moyrorL):
    ...
    bob.settings(straight_acceleration=300)
    hub.light.on(Color.GREEN)


    moyrorL.run_angle(1000, 100, wait=False)

    bob.straight(570)

    moyrorL.run_angle(900, -200)
