...
def Everett_Grace_Function(hub, bob, moyrorR):
    ...
    bob.straight(-500)
    '''
    moyrorR.run_time(2374 , 937)
    moyrorR.run_time(-400, 880)
    bob.settings(100)
    bob.straight(600)
    bob.straight(-50)
    moyrorR.run_angle(10000, 1000,wait=False)
    bob.settings(straight_speed=50)
    bob.straight(100)
