...
def light_show_run(hub, bob, moyrorR):
    ...
    moyrorR.run_angle(1001, 670*ratio)
    ...
    print("Arm Down")
    #moyrorR.run_angle(900,530*ratio)
    moyrorR.run_angle(900,1130)
    ...
    bob.straight(-35)
    print("Light Show Up")
    moyrorR.run_angle(-400, 4000*ratio, Stop.HOLD, wait=True)
    bob.straight(-5)
    moyrorR.run_angle(-4005, 4000*ratio, Stop.HOLD, wait=True)
